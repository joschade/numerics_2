...
if __name__ == "__main__":
    ...
    print(f'{df_gmres=}')
    df_gmres_pivot = df_gmres.pivot(columns='epsilon', index='h', values='iters')
    ...
    print(f'{df_jacobi=}')
    df_jacobi_pviot = df_jacobi.pivot(columns='epsilon', index='h', values='iters')
    ...
    df_gauss_seidel_pivot = df_gauss_seidel.pivot(columns='epsilon', index='h', values='iters')
